...
Hardware CSV note: `cartpole_action_trace_hw.csv` is generated by cocotb via `test_cartpole_action_trace` (run with `FULL_DEBUG=1`); see `../../common/sv/cocotb/README.md` for the command flow.
...
python compare_action_traces.py \
  ...
  --hw ../../../common/sv/cocotb/results/cartpole_action_trace_hw.csv
```
