// Neural Network Top-Level Module — ARCHIVED REFERENCE (serial fc1/fc2)
//
// This is the legacy serial-MAC implementation, preserved as the equivalence
// reference for the parallel rewrite of neural_network.sv. It is not used
// in production builds; only the equivalence testbench and any explicit
// regression target should reference it. Module contents are an exact copy
// of the original neural_network.sv with the module name suffixed (and
// instantiating linear_layer_serial for fc1/fc2) so both versions can be
// elaborated side-by-side in the equivalence wrapper.
//
