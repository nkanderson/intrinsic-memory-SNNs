// Neural Network Top-Level Module (fractional LIF) — ARCHIVED REFERENCE (serial fc1/fc2)
//
// This is the legacy serial-MAC implementation, preserved as the equivalence
// reference for the parallel rewrite of neural_network_fractional.sv. It is not
...
// of the pre-refactor neural_network_fractional.sv with the module name suffixed
...
module neural_network_fractional_serial #(
