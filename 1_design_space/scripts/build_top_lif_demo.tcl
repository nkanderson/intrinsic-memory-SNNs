# Vivado batch build script for top_lif_demo

set script_dir [file dirname [file normalize [info script]]]
set root_dir [file normalize [file join $script_dir ..]]
set common_neuron_dir [file normalize [file join $root_dir .. common sv neurons]]

set proj_name top_lif_demo
set proj_dir [file join $root_dir results lif vivado_project]
set top_name top_lif_demo
set results_dir [file join $root_dir results lif]
...
add_files [file join $common_neuron_dir lif_v1.sv]
add_files [file join $root_dir sv hex7seg.sv]
add_files [file join $root_dir sv top_lif_demo.sv]
