// Nexys A7-100T board top for the fractional-32-4-16 SNN configuration.
...
//
// Pins (see constraints/nexys_a7_fractional_32_4_16.xdc):
...
// `cp_integration_frac-32-4-16` so the FPGA matches the simulated reference.

module board_top_fractional_32_4_16 (
    ...
    // --- Accelerator wrapper ------------------------------------------
    // Weight .mem files come from common/sv/cocotb/tests/weights/fractional-32-4-16/;
